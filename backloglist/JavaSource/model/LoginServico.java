...
public class LoginServico {
	...
	public Usuario buscaLoginWS(String login) throws Exception {
		...
		if (usuarioWS == null){
			...
			throw new Exception("Usuário não encontrado, se você não possui login de acesso utilize a opção \"Solicite o seu acesso\" na página http://efika/web");
	...
	public void autenticaLogin(Usuario usuario, String senha) throws Exception {
		...
		if (!auth) {
			...
			throw new Exception("Login e senha incorretos, se você esqueceu da sua senha utilize a opção \"Esqueci minha senha\" na página http://efika/web");
